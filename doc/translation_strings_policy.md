...
This document provides guidelines for internationalization of the OCIDE Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ocide_en.ts` remains unchanged.
