OCIDE Core version 0.10.4 is now available from:

  <https://ocide.org/bin/ocide-core-0.10.4/>
...
- #6953 `43c2789` Split ocide-tx into its own package
- #6953 `dfe0d4d` Include ocide-tx binary on Debian/Ubuntu
