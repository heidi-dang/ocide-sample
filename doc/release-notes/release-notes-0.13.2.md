OCIDE Core version 0.13.2 is now available from:

  <https://ocide.org/bin/ocide-core-0.13.2/>
...
- #8908 `4a974b2` Update ocide-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ocide-tx to create v2 transactions (ocidedrak)
