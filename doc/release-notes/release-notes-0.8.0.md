OCIDE-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ocide/files/OCIDE/ocide-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the OCIDE
...
New/changed settings (command-line or ocide.conf file)
--------------------------------------------------------
