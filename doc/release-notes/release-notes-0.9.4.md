OCIDE Core version 0.9.4 is now available from:

  https://ocide.org/bin/0.9.4/
...
this update is incompatible with the OCIDE system and could lead to consensus
forks.

OCIDE Core released binaries from https://ocide.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ocide/+archive/ubuntu/ocide
- A third-party or self-compiled OCIDE Core

upgrade to OCIDE Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
