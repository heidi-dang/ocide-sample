OCIDE version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ocide/files/OCIDE/ocide-0.5.4/
...
http://gitorious.org/ocide/ocided-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix OCIDE-Qt notifications under Growl 1.3.
Increase required age of OCIDE-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOCIDE properly when installing OCIDE-Qt over it. (Windows)
