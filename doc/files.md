...
* ocide.conf: contains configuration settings for ocided or ocide-qt
* ocided.pid: stores the process id of ocided while running
...
* debug.log: contains debug information and general logging generated by ocided or ocide-qt
