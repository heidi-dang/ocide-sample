...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all OCIDE related functionality
...
/*
    ...
    allow endless transaction that would bloat OCIDE and make it unusable. To
