...
static const int64_t SPORK_5_INSTANTSEND_MAX_VALUE_DEFAULT              = 1000;         // 1000 OCIDE
...
static const int64_t SPORK_15_SPOS_ENABLED_FLAG_DEFAULT                 = 0;            // ON
}
...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        case SPORK_15_SPOS_ENABLED:                     r = SPORK_15_SPOS_ENABLED_FLAG_DEFAULT; break;
        default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    case SPORK_15_SPOS_ENABLED:        return SPORK_15_SPOS_ENABLED_FLAG_DEFAULT;
    default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_SPOS_ENABLED")                     return SPORK_15_SPOS_ENABLED;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    ...
    case SPORK_15_SPOS_ENABLED:                     return "SPORK_15_SPOS_ENABLED";
    default:
