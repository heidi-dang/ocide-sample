...
void CDSNotificationInterface::AcceptedBlockHeader(const CBlockIndex *pindexNew)
{
    ...
    securenodeSync.AcceptedBlockHeader(pindexNew);
}

void CDSNotificationInterface::NotifyHeaderTip(const CBlockIndex *pindexNew, bool fInitialDownload)
{
    masternodeSync.NotifyHeaderTip(pindexNew, fInitialDownload, connman);
    securenodeSync.NotifyHeaderTip(pindexNew, fInitialDownload, connman);
}
...
void CDSNotificationInterface::UpdatedBlockTip(const CBlockIndex *pindexNew, const CBlockIndex *pindexFork, bool fInitialDownload)
{
    ...
    securenodeSync.UpdatedBlockTip(pindexNew, fInitialDownload, connman);

    if (fInitialDownload)
        return;

    mnodeman.UpdatedBlockTip(pindexNew);
    securenodeman.UpdatedBlockTip(pindexNew);
