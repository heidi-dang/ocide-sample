...
const char *SECURENODEVERIFY="mrnv";
const char *SECURENODEANNOUNCE="mrnan";
const char *SECURENODEPING="mrnp";
const char *SECURENODESEG="mrnseg";
const char *SECURESYNCSTATUSCOUNT="mrnssc";
} // namespace NetMsgType
...
const static std::string allNetMessageTypes[] = {
    ...
    NetMsgType::DSQUEUE,
    NetMsgType::DSEG,
    NetMsgType::SECURENODESEG,
    NetMsgType::SYNCSTATUSCOUNT,
    NetMsgType::SECURESYNCSTATUSCOUNT,
    NetMsgType::MNGOVERNANCESYNC,
    NetMsgType::MNGOVERNANCEOBJECT,
    NetMsgType::MNGOVERNANCEOBJECTVOTE,
    NetMsgType::MNVERIFY,
    NetMsgType::SECURENODEVERIFY,
    NetMsgType::SECURENODEANNOUNCE,
    NetMsgType::SECURENODEPING
};
...
std::string CInv::GetCommand() const
{
    ...
    case MSG_SECURENODE_VERIFY: return cmd.append(NetMsgType::SECURENODEVERIFY);
    case MSG_SECURENODE_ANNOUNCE: return cmd.append(NetMsgType::SECURENODEANNOUNCE);
    case MSG_SECURENODE_PING: return cmd.append(NetMsgType::SECURENODEPING);
    default:
