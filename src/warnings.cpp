...
std::string GetWarnings(const std::string& strFor)
{
    ...
    if (!CLIENT_VERSION_IS_RELEASE) {
        strStatusBar = "This is a pre-release test build - use at your own risk - do not use for mining or secure applications";
        strGUI = _("This is a pre-release test build - use at your own risk - do not use for mining or secure applications");
    }
