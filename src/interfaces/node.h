...
struct MasternodeSecurenodeCountInfo
{
    int64_t size;
    int64_t countEnabledProtVersion;
    int64_t countEnabled;

    MasternodeSecurenodeCountInfo(int64_t sz, int64_t cept, int64_t ce){
        size = sz;
...
//! Top-level interface for a ocide node (ocided process).
class Node
{
public:
    virtual ~Node() {}
    ...
    virtual MasternodeSecurenodeCountInfo getNumMasternodes() = 0;

    //! Get num of masternodes
    virtual MasternodeSecurenodeCountInfo getNumSecurenodes() = 0;
