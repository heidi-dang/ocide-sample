...
class NodeImpl : public Node
{
    ...
    MasternodeSecurenodeCountInfo getNumMasternodes() override
    {
        MasternodeSecurenodeCountInfo mnCount(mnodeman.size(), mnodeman.CountEnabled(PROTOCOL_VERSION), mnodeman.CountEnabled());
        return mnCount;
    }
    MasternodeSecurenodeCountInfo getNumSecurenodes() override
    {
        MasternodeSecurenodeCountInfo mnCount(securenodeman.size(), securenodeman.CountEnabled(PROTOCOL_VERSION), securenodeman.CountEnabled());
        return mnCount;
    }
