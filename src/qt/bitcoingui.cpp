    ...
    platformStyle(_platformStyle)
{
    ...
    QString windowTitle = tr("OCIDE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OCIDE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ocide: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About OCIDE Core"), this);
    aboutAction->setStatusTip(tr("Show information about OCIDE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OCIDE Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OCIDE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OCIDE addresses"));
    ...
    openAction->setStatusTip(tr("Open a ocide: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OCIDE Core help message to get a list with possible OCIDE Core command-line options"));
...
void BitcoinGUI::createToolBarWidgets(QToolBar *toolbar)
{
    ...
    std::tie(label, sendCoinsAction) = CreateWidgetHelper("send", tr("Send coins to a OCIDE address"));

    shortcut = CreateShortcut(Qt::Key_4);

    std::tie(label, receiveCoinsAction) = CreateWidgetHelper("receive", tr("Request payments (generates QR codes and ocide: URIs)"));

    shortcut = CreateShortcut(Qt::Key_5);

    std::tie(label, sposTabAction) = CreateWidgetHelper("spos", tr("Stake coins using trustless staking"));
    ...
    //    std::tie(label, secureAction) = CreateWidgetHelper("secure", tr("Secure"));
    ...
    connect(sendCoinsAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(sendCoinsAction, SIGNAL(triggered()), this, SLOT(gotoSendCoinsPage()));
    connect(sposTabAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(sposTabAction, SIGNAL(triggered()), this, SLOT(gotoSPoSPage()));
    connect(receiveCoinsAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(receiveCoinsAction, SIGNAL(triggered()), this, SLOT(gotoReceiveCoinsPage()));
    connect(historyAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(historyAction, SIGNAL(triggered()), this, SLOT(gotoHistoryPage()));
    ...
    connect(secureAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(secureAction, SIGNAL(triggered()), this, SLOT(gotoSecurePage()));
#endif // ENABLE_WALLET
}
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("OCIDE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::gotoSPoSPage()
{
    sposTabAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSPoSPage();
}
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OCIDE network", "", count));
    } else {
...
{
    QString strTitle = tr("OCIDE Core"); // default title
