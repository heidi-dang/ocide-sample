...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        setSecurenodeCount(model->getSecurenodeCountString());
        connect(model, SIGNAL(strSecurenodesChanged(QString)), this, SLOT(setSecurenodeCount(QString)));
...
void RPCConsole::setSecurenodeCount(const QString &strSecurenodes)
{
    ui->securenodeCount->setText(strSecurenodes);
}
