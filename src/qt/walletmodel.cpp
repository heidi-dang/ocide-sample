...
#include <qt/sposaddressestablemodel.h>
    ...
    cachedNumBlocks(0)
{
    ...
    sposTableModel = new SPoSAddressesTableModel(this, optionsModel);
...
WalletModel::SendCoinsReturn WalletModel::sendCoins(WalletModelTransaction &transaction)
{
...

    {
        ...
        for (const SendCoinsRecipient &rcp : transaction.getRecipients())
        {
            ...
            else if (!rcp.message.isEmpty()) // Message from normal ocide:URI (ocide:123...?message=example)
...
SPoSAddressesTableModel *WalletModel::getSPoSAddressModel() const
{
    return sposTableModel;
}
