...
# TestP2PConn: A peer we use to send messages to ocided, and store responses.
...
class CompactBlocksTest(OCIDETestFramework):
    ...
    # This test actually causes ocided to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ocided requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ocided to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # ocided will not send blocktxn responses for blocks whose height is
